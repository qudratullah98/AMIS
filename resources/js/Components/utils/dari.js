...
const dari = {
    ...
    error: {
        ...
        organization: {
            name_is_required: "نام سازمان ضروری است.",
            code_unique: "این کد قبلاً ثبت شده است.",
            email_unique: "این ایمیل قبلاً ثبت شده است.",
            phone_unique: "این شماره تماس قبلاً ثبت شده است.",
            website_url: "آدرس وب‌سایت معتبر نیست.",
        },
        tashkil: {
            year_required: "سال الزامی است.",
            ...
            reference_number_max: "شماره مرجع نباید بیشتر از 255 کاراکتر باشد.",
            reference_number_unique: "شماره مرجع قبلاً ثبت شده است.",

            organization_id_required: "انتخاب سازمان الزامی است.",
            organization_id_exists: "سازمان انتخاب‌شده معتبر نیست.",
    ...
    flight: {
        ...
        createFlight: "پرواز جدید",
        arrival: "ورود",
        departureTime: "زمان پرواز",
        arrivalTime: "زمان ورود",
        flightServices: "خدمات پرواز",
        airport: "فرودگاه",
        airline: "شرکت هوایی",
        aircraft_type: "نوع طیاره",
        aircraft_registration: "شماره ثبت طیاره",
        flight_number: "شماره پرواز",
        charge_note: "یادداشت مصارف",
        arrival_date: "تاریخ ورود",
        departure_date: "تاریخ پرواز",
        approximate_time_arrival: "زمان تقریبی ورود",
        approximate_time_departure: "زمان تقریبی پرواز",
        save_service: "ثبت خدمت",
        loading: "در حال بارگذاری...",
        saving: "در حال ثبت...",
        flightServicesList: "لیست خدمات پرواز",
        newFlightServices: "خدمات جدید پرواز",
        searchFlightNumber: "جستجوی شماره پرواز",
    },

...
function Index() {
    ...
    const cardData = [
        ...
        { title: "صلاحیت ها", href: "user/rolls", icon: <Accessibility className="w-8 h-8 text-green-500" />, stats: [{ value: 5, label: "Total" }, { value: 2, label: "Pending" }, { value: 3, label: "Filled" }] },
    ];

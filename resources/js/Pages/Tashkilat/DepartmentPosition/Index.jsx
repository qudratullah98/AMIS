...
function Index({ positions }) {
    ...
    const [positionsData, setPositionsData] = useState(positions?.data || []);
        ...
        >
            ...
            {createModal && (
                <CustomModal
                    ...
                    title={t("tashkilat.createDepartmentPosition")}
                    size="large"
                    footer={false}
                ...
                >
                    <CreateDepartmentPosition
                        onSubmitSuccess={(newPosition) => {
                            ...
                            setPositionsData((prev) => [newPosition, ...prev]);
                        }}
                    />
                </CustomModal>
            )}
                ...
                >
                    <div className="px-4 py-2">
                        <DataTable
                            ...
                            header={t("tashkilat.departmentPositions")}
                            enableButton={true}
                            buttonLabel={t(
                                "tashkilat.createDepartmentPosition",
                            )}

...
function CreateTrainingPlan({ onSubmitSuccess, onCancel }) {
    ...
    const validationSchema = Yup.object({
        ...
        start_date: Yup.date()
            .required(t("error.required"))
            .min(new Date().toISOString().split('T')[0], t("error.trainingPlans.futureDate")),
        end_date: Yup.date()
            .required(t("error.required"))
            .min(Yup.ref('start_date'), t("error.trainingPlans.endDateAfterStart")),
        location: Yup.string()
            .nullable()
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, setErrors }) => {
            try {
                const response = await axios.post(route('training-plans.store'), values);
                if (onSubmitSuccess) {
    ...
    const statusOptions = [
        { value: 'planned', label: t('education.trainingPlans.statuses.planned') },
        { value: 'in_progress', label: t('education.trainingPlans.statuses.in_progress') },
        { value: 'completed', label: t('education.trainingPlans.statuses.completed') },
        { value: 'cancelled', label: t('education.trainingPlans.statuses.cancelled') },
    ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                    ...
                    <TextInput
                        ...
                        placeholder={t("education.trainingPlans.namePlaceholder")}
                ...
                <div>
                    ...
                    <CustomSelect
                        ...
                        placeholder={t("education.trainingPlans.selectCourse")}
                ...
                <div>
                    ...
                    <CustomSelect
                        ...
                        placeholder={t("education.trainingPlans.selectTrainer")}
                        className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none bg-white ${
                ...
                <div>
                    <InputLabel
                        value={t("education.trainingPlans.startDate")}
                        required={true}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <TextInput
                ...
                <div>
                    <InputLabel
                        value={t("education.trainingPlans.endDate")}
                        required={true}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <TextInput
                ...
                <div>
                    <InputLabel
                        value={t("education.trainingPlans.location")}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <TextInput
                        name="location"
                        ...
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        placeholder={t("education.trainingPlans.locationPlaceholder")}
                        className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none ${
                ...
                <div>
                    <InputLabel
                        value={t("education.trainingPlans.status")}
                        required={true}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <CustomSelect
                        ...
                        placeholder={t("education.trainingPlans.selectStatus")}
                        className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 outline-none bg-white ${
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        placeholder={t("education.trainingPlans.descriptionPlaceholder")}
                        rows="3"

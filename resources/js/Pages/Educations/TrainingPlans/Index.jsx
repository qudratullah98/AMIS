    ...
    const handleDelete = (trainingPlan) => {
        if (confirm(t("common.confirmDelete"))) {
            router.delete(route('training-plans.destroy', trainingPlan.id), {
                onSuccess: () => {
                    setData((prev) => prev.filter((item) => item.id !== trainingPlan.id));
                },
            });
        }
    };
    ...
    return (
        ...
        >
            ...
            <DataTable
                ...
                enableButton
                buttonLabel={t("education.trainingPlans.createTrainingPlan")}
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                {plan.duration_days && (
                                    <div className="text-xs text-gray-400 flex items-center gap-1">
                                        ...
                                        {plan.duration_days} {t('education.trainingPlans.days')}
                                    </div>
                                )}
                            </div>
                        </td>

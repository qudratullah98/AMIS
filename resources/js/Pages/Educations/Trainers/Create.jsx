...
function CreateTrainer({ onSubmitSuccess, onCancel }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, setErrors }) => {
            try {
                const response = await axios.post(route('trainers.store'), values);
                if (onSubmitSuccess) {
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                    <InputLabel
                        value={t("education.trainers.name")}
                        required={true}
                ...
                <div>
                    <InputLabel
                        value={t("education.trainers.type")}
                        required={true}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <CustomSelect
                ...
                <div>
                    <InputLabel
                        value={t("education.trainers.phone")}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <TextInput
                        name="phone"
                ...
                <div>
                    <InputLabel
                        value={t("education.trainers.email")}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <TextInput
                        name="email"
                ...
                <div>
                    <InputLabel
                        value={t("education.trainers.organization")}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <TextInput
                        name="organization"
                ...
                <div className="md:col-span-2">
                    <InputLabel
                        value={t("education.trainers.address")}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <textarea
                        name="address"
                ...
                <div className="md:col-span-2">
                    <InputLabel
                        value={t("education.trainers.description")}
                        className="text-sm font-medium text-gray-700 mb-1.5 block"
                    />
                    <textarea
                        name="description"

    ...
    useEffect(() => {
        const fetchDropdowns = async () => {
            try {
                ...
                setData("province_id", airport.province_id || "");
                if (airport.province_id) {
                    const distRes = await axios.get(
                        route("api_districts_by_province", {
                            province_id: airport.province_id,
                        }),
                    );
                    setDistricts(distRes.data);
                    setData("district_id", airport.district_id || "");
                }
            } catch (err) {
        ...
        if (editable) {
            try {
                const response = await axios.post(
                    route("airport.update", { airport: airport.id }),
                    data,
                );
                reset();
                if (onEditSuccess) onEditSuccess(response.data.airport);
            } catch (err) {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 rounded-xl shadow-sm">
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                value={data.name_ps}
                                onChange={(e) =>
                                    setData("name_ps", e.target.value)
                                }
                            />
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                value={data.name_dr}
                                onChange={(e) =>
                                    setData("name_dr", e.target.value)
                                }
                            />
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    setData("IATA_code", e.target.value)
                                }
                            />
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    setData("ICAO_code", e.target.value)
                                }
                            />

  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 rounded-xl shadow-sm">
        ...
        {/* Name PS */}
        <div>
          <IconLabel htmlFor="name_ps" icon="🛫" text={t("Name (Pashto)")} />
          <TextInput
            id="name_ps"
            value={data.name_ps}
        ...
        {/* Name DR */}
        <div>
          <IconLabel htmlFor="name_dr" icon="🛫" text={t("Name (Dari)")} />
          <TextInput
            id="name_dr"
            value={data.name_dr}
        ...
        {/* Name EN */}
        <div>
          <IconLabel htmlFor="name_en" icon="✈️" text={t("Name (English)")} />
          <TextInput
            id="name_en"
            value={data.name_en}
        ...
        {/* Province */}
        <div>
          <IconLabel htmlFor="province_id" icon="📍" text={t("Province")} />
          <CustomSelect
            id="province_id"
            options={provinces.map((p) => ({ value: p.id, label: p.province }))}
        ...
        {/* District */}
        <div>
          <IconLabel htmlFor="district_id" icon="📍" text={t("District")} />
          <CustomSelect
            id="district_id"
            value={data.district_id}
            options={districts.map((d) => ({ value: d.id, label: d.district_dr }))}
        ...
        {/* AMSL Unit */}
        <div>
          <IconLabel htmlFor="amsl_unit_id" icon="📏" text="AMSL Unit" />
          <CustomSelect
            id="amsl_unit_id"
            value={data.amsl_unit_id}
            options={units.map((u) => ({ value: u.id, label: u.unit_ps }))}
        ...
        {/* Area Unit */}
        <div>
          <IconLabel htmlFor="area_unit_id" icon="📐" text="Area Unit"/>
          <CustomSelect
            id="area_unit_id"
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <IconLabel htmlFor="description" icon="📝" text={t("Description")} />
        <textarea
          id="description"
